...
int main(int argc, char *argv[])
{
    ...
    int recvcounts[NTASKS] = {1, 1, 2, 4};
    int displc[NTASKS] = {0, 1, 2, 4};
    ...
    printf("recvcounts of process %i: %i\n", rank, recvcounts[rank]);
    MPI_Barrier(MPI_COMM_WORLD); 
    printf("displc of process %i: %i\n", rank, displc[rank]);
    MPI_Barrier(MPI_COMM_WORLD);
    ...
    MPI_Gatherv(sendbuf, recvcounts[rank], MPI_INT, recvbuf, recvcounts, displc, MPI_INT, 1, MPI_COMM_WORLD);
